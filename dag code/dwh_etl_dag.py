...
load_facilities >>  load_ct_patients >> load_art_patients >> load_ct_patient_visits  >> load_patient_labs
...
load_ct_defaulter_tracing >> load_ct_gbv_screening >> load_ct_otz >> load_ct_ovc >> load_ct_ipt