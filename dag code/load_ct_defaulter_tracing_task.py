...
def build_load_ct_defaulter_tracing_task(dag: DAG) -> SparkSubmitOperator:
    load_ct_defaulter_tracing = SparkSubmitOperator(task_id='load_ct_defaulter_tracing',
                                              conn_id='spark_standalone',
                                              application=f'{spark_app_home}/load-ct-defaulter-tracing-1.0-SNAPSHOT-jar-with-dependencies.jar',
