...
def build_load_ct_gbv_screening_task(dag: DAG) -> SparkSubmitOperator:
    load_ct_gbv_screening = SparkSubmitOperator(task_id='load_ct_gbv_screening',
                                              conn_id='spark_standalone',
                                              application=f'{spark_app_home}/load-ct-gbv-screening-1.0-SNAPSHOT-jar-with-dependencies.jar',
