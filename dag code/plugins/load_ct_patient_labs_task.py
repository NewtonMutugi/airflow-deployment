...
lpl_spark_source_metadata_table = Variable.get("LPL_SPARK_SOURCE_METADATA_TABLE")
lpl_spark_sink_dbtable = Variable.get("LPL_SPARK_SINK_DBTABLE")

def build_load_patient_labs_task(dag:DAG):
    load_patient_labs = SparkSubmitOperator(task_id='load_patient_labs',
                                              ...
                                              conf={
                                                ...
                                                "spark.source.metadata-table": lpl_spark_source_metadata_table,
