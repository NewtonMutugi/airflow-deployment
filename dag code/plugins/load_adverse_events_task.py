...
lae_spark_source_metadata_table = Variable.get("LAE_SPARK_SOURCE_METADATA_TABLE")
lae_spark_sink_dbtable = Variable.get("LAE_SPARK_SINK_DBTABLE")

def build_load_adverse_events_task(dag:DAG):
    load_adverse_events = SparkSubmitOperator(task_id='load_adverse_events',
                                              conn_id='spark_standalone',
                                              application=f'{spark_app_home}/load-adverse-events-1.0-SNAPSHOT-jar-with-dependencies.jar',
                                              ...
                                              conf={
                                                ...
                                                "spark.source.metadata-table": lae_spark_source_metadata_table,
