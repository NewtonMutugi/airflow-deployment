...
def build_load_ct_contact_listing_task(dag: DAG) -> SparkSubmitOperator:
    load_ct_contact_listing = SparkSubmitOperator(task_id='load_ct_contact_listing',
                                              conn_id='spark_standalone',
                                              application=f'{spark_app_home}/load-ct-contact-listing-1.0-SNAPSHOT-jar-with-dependencies.jar',
