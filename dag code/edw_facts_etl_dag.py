...
from includes.load_fact_prep_task import build_load_fact_prep
...
load_fact_prep = build_load_fact_prep(dag = dag, default_conf = default_conf)
...
load_fact_hts_test_kits >> load_fact_latest_obs >> load_fact_otz >> load_fact_ovc >> load_fact_prep