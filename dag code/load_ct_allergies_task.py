...
def build_load_ct_allergies_task(dag: DAG) -> SparkSubmitOperator:
    load_ct_allergies = SparkSubmitOperator(task_id='load_ct_allergies',
                                              conn_id='spark_standalone',
                                              application=f'{spark_app_home}/load-ct-allergies-chronic-illness-1.0-SNAPSHOT-jar-with-dependencies.jar',
