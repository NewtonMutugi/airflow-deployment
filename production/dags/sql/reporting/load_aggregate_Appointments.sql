...
with Bookings AS (
    ...
    from NDWH.dbo.FACTAppointments apt
    ...
    group by Facilitykey,EOMONTH(ExpectedNextAppointmentDate),PartnerKey,patient.Gender,age_group.DATIMAgeGroup,AgencyKey
