...
from includes.reporting.load_sp_generate_consistency_uploads_nw_task import build_load_sp_generate_consistency_uploads_nw_task
...
load_sp_generate_consistency_uploads_task = build_load_sp_generate_consistency_uploads_task(
    dag=dag)
load_sp_generate_consistency_uploads_nw_task = build_load_sp_generate_consistency_uploads_nw_task(
    dag=dag)
...
reporting_aggregates_etl_trigger >> load_linelist_PrepAssessments_task >> load_sp_generate_consistency_uploads_task >> load_sp_generate_consistency_uploads_nw_task
