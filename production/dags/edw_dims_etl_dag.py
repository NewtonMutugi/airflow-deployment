...
from includes.load_dim_vaccination_status_task import build_load_dim_vaccination_status
from includes.load_dim_family_planning_task import build_load_dim_family_planning
...
load_dim_vaccination_status = build_load_dim_vaccination_status(dag = dag, default_conf = default_conf)
load_dim_family_planning = build_load_dim_family_planning(dag = dag, default_conf = default_conf)
...
load_dim_test_kit_name >>  load_dim_treatment_type >> load_dim_vaccination_status >> load_dim_family_planning >> edw_facts_etl_trigger
