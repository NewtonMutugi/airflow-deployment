...
def build_load_intermediate_pbfw_task(dag: DAG, default_conf):
    intermediate_pbfw = BashOperator(task_id='intermediate_pbfw',
                          dag=dag,
                          bash_command=f"java -jar {default_conf['spark_app_home']}/load-intermediate-pbfw-1.0-SNAPSHOT-jar-with-dependencies.jar",
                          env={
