...
def build_load_intermediate_latest_diabetes_tests_task(dag: DAG, default_conf):
    load_intermediate_latest_diabetes_tests = BashOperator(task_id='load_intermediate_latest_diabetes_tests',
                          dag=dag,
                          bash_command=f"java -jar {default_conf['spark_app_home']}/load-intermediate-latest-diabetes-tests-1.0-SNAPSHOT-jar-with-dependencies.jar",
                          env={
